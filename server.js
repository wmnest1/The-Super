        ...
        crew: {
          ...
          items: {
            ...
            properties: {
              ...
              hours: { type: "string", description: "Regular (contract) hours worked, e.g. '8' or '5'. Use '0' if all hours were out of scope." },
  ...
  switch (toolName) {
    case "save_entry": {
      ...
      const entry = {
        ...
        crew: (input.crew || []).map(c => ({ name: c.name, hours: c.hours || '0', ...(parseFloat(c.oosHours||0) > 0 ? { oosHours: String(c.oosHours) } : {}) })),
